...
- `docs/specs/` contains the Wave 1 umbrella spec, promoted contract specs for all six Wave 1 systems, Wave 2 Block A continuity baseline specs, and the Wave 2 Block B1 standing-risk derived baseline spec.
- Wave 2 Block C and Block D specs are not implemented yet.
