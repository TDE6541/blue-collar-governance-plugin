...
- Remaining Wave 5B runtime behavior is still pending.
- No installable plugin package, runtime hook path, or compatibility layer is implemented yet.
- Skills outside the Session Lifecycle tranche, skins, onboarding, package/install, and marketplace packaging are not implemented yet.
